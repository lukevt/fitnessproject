...
export default class Landing extends Component {
    render() {
        let url ="https://cdn.pixabay.com/photo/2020/04/06/16/44/silhouette-5010366_1280.png"
        return (
            <div>
                ...
                <div style={{display:"flex", width:"920px", position:"absolute", top:"10%", left:"20%", border:"1px solid #C5B358", borderRadius:10, backgroundImage:`url(${url})`}}>
